import { Users, TrendingUp, Award, MessageSquare, UserPlus, Search } from "lucide-react"
              ...
              <Card className="bg-gray-900 border-gray-800">
                ...
                <CardContent className="space-y-4">
                  {topUsers.map((user, index) => (
                    <div key={user.id} className="flex items-center gap-3 p-3 rounded-lg bg-gray-800/50">
                      ...
                      <div className="text-right">
                        <div className="text-sm font-semibold text-gray-100">{user.posts} posts</div>
                  ...
                  {trendingTopics.map((topic, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-100">{topic.name}</p>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {suggestedUsers.map((user) => (
                    <div key={user.id} className="p-4 rounded-lg bg-gray-800/50 text-center">
                      ...
                      <p className="text-sm text-gray-300 mb-2">{user.specialty}</p>
                      <p className="text-xs text-gray-400 mb-3">{user.mutualFollowers} mutual followers</p>
                      <Button
                        size="sm"
